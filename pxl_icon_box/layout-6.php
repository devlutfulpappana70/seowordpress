...
?>
<div class="pxl-icon-box pxl-icon-box6 <?php echo esc_attr($settings['style_type']); ?> ">
	<div class="pxl-item-inner <?php echo esc_attr($settings['pxl_animate1']); ?>" data-wow-delay="<?php echo esc_attr($settings['pxl_animate_delay1']); ?>ms">
		<a class="pxl-meta-content" <?php pxl_print_html($widget->get_render_attribute_string( 'link_text' )); ?>>
