<?php 
$logo_m = seon()->get_opt( 'logo_m', ['url' => get_template_directory_uri().'/assets/img/logo.png', 'id' => '' ] );
$p_menu = seon()->get_page_opt('p_menu');
$header_mobile = seon()->get_page_opt('header_mobile', 'show');
$sticky_scroll = seon()->get_opt('sticky_scroll');
...
$opt_mobile_style = seon()->get_opt('opt_mobile_style');
$mobile_display = seon()->get_opt('mobile_display');
$header_mobile_layout = seon()->get_opt('header_mobile_layout');
$header_mobile_layout_count = (int)seon()->get_opt('header_mobile_layout');
                    ...
                    <div class="row">
                        ...
                        <div class="pxl-header-menu">
                            <div class="pxl-header-menu-scroll">
                                ...
                                <?php seon_header_mobile_search_form(); ?>
