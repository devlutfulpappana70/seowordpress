...
pxl_add_custom_widget(
    array(
        'name' => 'pxl_carousel_custom',
        'title' => esc_html__('Case Carousel Custom', 'seon'),
            ...
            'sections' => array(
                        ...
                        array(
                            ...
                            'options' => [
                                '1' => [
                                    ...
                                    'image' => get_template_directory_uri() . '/elements/widgets/img-layout/pxl_carousel_custom/layout1.jpg'
                                ],
                            ],
                        ),
                    ),
                ...
                array(
                    ...
                    'controls' => array(
                        array(
                            'name' => 'carousel',
                            'label' => esc_html__('Carousel', 'seon'),
                            ...
                            'controls' => array(
                                ...
                                array(
                                    'name' => 'chart_title',
                                    'label' => esc_html__('Chart Title', 'seon'),
                                    'type' => \Elementor\Controls_Manager::TEXT,
                                    'label_block' => true,
                                ),
                                array(
                                    'name' => 'percentage_value',
                                    'label' => esc_html__('Percentage Value', 'seon'),
                                ...
                                array(
                                    'name' => 'chart_size',
                                    'label' => esc_html__('Chart Size', 'seon' ),
                                ...
                                array(
                                    'name' => 'counter_number',
                                    'label' => esc_html__('Counter Number', 'seon'),
                                    'type' => \Elementor\Controls_Manager::NUMBER,
                                    'default' => 100,
                                ),
                                array(
                                    'name' => 'counter_suffix',
                                    'label' => esc_html__('Counter Suffix', 'seon'),
                                    'type' => \Elementor\Controls_Manager::TEXT,
                                    'default' => '',
                                ),
                                array(
                                    'name' => 'bar_color_to',
                                    'label' => esc_html__('Bar Color To', 'seon' ),
                                    'type' => \Elementor\Controls_Manager::COLOR,
                                ),
                                array(
                                    'name' => 'bar_color_from',
                                    'label' => esc_html__('Bar Color From', 'seon' ),
                                    'type' => \Elementor\Controls_Manager::COLOR,
                                ),
                                array(
                                    'name' => 'chart_line_width',
                                    'label' => esc_html__('Chart Line Width', 'seon' ),
                                    'type' => \Elementor\Controls_Manager::SLIDER,
                                    'size_units' => [ 'px' ],
                                    'default' => [
                                        'size' => 14,
                                ...
                                array(
                                    'name' => 'chart_line_cap',
                                    'label' => esc_html__('Chart Line Cap', 'seon' ),
                                ...
                                array(
                                    'name' => 'category',
                                    'label' => esc_html__('Category', 'seon'),
                                    'type' => \Elementor\Controls_Manager::TEXT,
                                    'label_block' => true,
                                ),
                                array(
                                    'name' => 'tag',
                                    'label' => esc_html__('Tag', 'seon'),
                                    'type' => \Elementor\Controls_Manager::TEXT,
                                    'label_block' => true,
                                ),
                                array(
                                ...
                                array(
                                    'name' => 'link_text',
                                    'label' => esc_html__('Link Text', 'seon'),
                                    'type' => \Elementor\Controls_Manager::TEXT,
                                    'label_block' => true,
                                ),
                                array(
                ...
                array(
                    ...
                    'controls' => array(
                        array(
                            ...
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}} .pxl-carousel-custom .pxl-item--title' => 'color: {{VALUE}};',
                            ],
                        ),
                        array(
                            ...
                            'control_type' => 'group',
                            'selector' => '{{WRAPPER}} .pxl-carousel-custom .pxl-item--title',
                        ),
                        array(
                            ...
                            'selectors' => [
                                '{{WRAPPER}}  .pxl-carousel-custom .pxl-item--title' => 'margin-bottom: {{SIZE}}{{UNIT}} !important;',
                            ],
                        ),
                    ),
                ),
                array(
                    ...
                    'controls' => array(
                        array(
                            ...
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}} .pxl-carousel-custom .pxl-item--desc' => 'color: {{VALUE}};',
                            ],
                        ),
                        array(
                            ...
                            'type' => \Elementor\Group_Control_Typography::get_type(),
                            'control_type' => 'group',
                            'selector' => '{{WRAPPER}} .pxl-carousel-custom .pxl-item--desc',
                        ),
                    ),
                ),
                ...
                array(
                    ...
                    'controls' => array(
                        array(
                            'name' => 'track_color',
                            'label' => esc_html__('Track Color', 'seon' ),
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}} .pxl-carousel-custom .pxl-pie-chart .pxl-item-divider' => 'border-color: {{VALUE}};',
                            ],
                        ),
                        array(
                            'name' => 'img_size',
