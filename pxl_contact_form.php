...
if(class_exists('WPCF7')) {
    ...
    if ($cf7) {
        ...
        $contact_forms[esc_html__('No contact forms found', 'seon')] = 0;
    }

    pxl_add_custom_widget(
        array(
            'name' => 'pxl_contact_form',
            'title' => esc_html__('Case Contact Form', 'seon'),
                ...
                'sections' => array(
                    array(
                        ...
                        'controls' => array(
                            array(
                                'name' => 'form_id',
                                'label' => esc_html__('Select Form', 'seon'),
                    ...
                    array(
                        ...
                        'controls' => array(
                            ...
                            array(
                                'name' => 'input_padding',
                                'label' => esc_html__('Padding Input', 'seon' ),
                            ...
                            array(
                                'name' => 'input_height',
                                'label' => esc_html__('Input Height', 'seon' ),
                            ...
                            array(
                                ...
                                'label' => esc_html__('Textarea Height', 'seon' ),
                                'type' => \Elementor\Controls_Manager::SLIDER,
                                'control_type' => 'responsive',
                                'size_units' => [ 'px' ],
                                'range' => [
                            ...
                            array(
                                ...
                                'label' => esc_html__('Padding Textarea', 'seon' ),
                                'type' => \Elementor\Controls_Manager::DIMENSIONS,
                                'size_units' => [ 'px' ],
                                'selectors' => [
                            ...
                            array(
                                ...
                                'label' => esc_html__( 'Textarea Border Type', 'seon' ),
                                'type' => \Elementor\Controls_Manager::SELECT,
                                'options' => [
                                    '' => esc_html__( 'None', 'seon' ),
                                    'solid' => esc_html__( 'Solid', 'seon' ),
                            ...
                            array(
                                ...
                                'label' => esc_html__( 'Textarea Border Width', 'seon' ),
                                'type' => \Elementor\Controls_Manager::DIMENSIONS,
                                'selectors' => [
                            ...
                            array(
                                ...
                                'label' => esc_html__('Textarea Typography', 'seon' ),
                                'type' => \Elementor\Group_Control_Typography::get_type(),
                                'control_type' => 'group',
                            ...
                            array(
                                'name' => 'textarea_color',
                                'label' => esc_html__('Textarea Color', 'seon' ),
                                'type' => \Elementor\Controls_Manager::COLOR,
                                'selectors' => [
                            ...
                            array(
                                ...
                                'label' => esc_html__('Item Spacer Bottom', 'seon' ),
                                'type' => \Elementor\Controls_Manager::SLIDER,
                                'control_type' => 'responsive',
                                'size_units' => [ 'px' ],
                                'range' => [
                            ...
                            array(
                                ...
                                'label' => esc_html__('Item Spacer Left', 'seon' ),
                                'type' => \Elementor\Controls_Manager::SLIDER,
                                'control_type' => 'responsive',
                                'size_units' => [ 'px' ],
                                'range' => [
                            ...
                            array(
                                ...
                                'label' => esc_html__('Item Spacer right', 'seon' ),
                                'type' => \Elementor\Controls_Manager::SLIDER,
                                'control_type' => 'responsive',
                                'size_units' => [ 'px' ],
                                'range' => [
                    ...
                    array(
                        ...
                        'label' => esc_html__('Input Hover', 'seon'),
                        'tab' => \Elementor\Controls_Manager::TAB_STYLE,
                        'controls' => array(
                            array(
                    ...
                    array(
                        ...
                        'label' => esc_html__('Button', 'seon'),
                        'tab' => \Elementor\Controls_Manager::TAB_STYLE,
                        'controls' => array_merge(
                            array(
                                array(
                                    'name' => 'button_typography',
                                    'label' => esc_html__('Button Typography', 'seon' ),
                                    'type' => \Elementor\Group_Control_Typography::get_type(),
                                    'control_type' => 'group',
                                ...
                                array(
                                    'name' => 'button_color',
                                    'label' => esc_html__('Button Color', 'seon' ),
                                    'type' => \Elementor\Controls_Manager::COLOR,
                                    'selectors' => [
                                ...
                                array(
                                    ...
                                    'label' => esc_html__('Button Color Hover', 'seon' ),
                                    'type' => \Elementor\Controls_Manager::COLOR,
                                    'selectors' => [
                                ...
                                array(
                                    ...
                                    'label' => esc_html__('Button Background Color', 'seon' ),
                                    'type' => \Elementor\Controls_Manager::COLOR,
                                    'selectors' => [
                                ...
                                array(
                                    ...
                                    'label' => esc_html__('Button Background Color Hover', 'seon' ),
                                    'type' => \Elementor\Controls_Manager::COLOR,
                                    'selectors' => [
                            ...
                            array(
                                ...
                                array(
                                    'name' => 'btn_spacer_top',
                                    'label' => esc_html__('Spacer Top', 'seon' ),
                                    'type' => \Elementor\Controls_Manager::SLIDER,
                                    'control_type' => 'responsive',
                                    'size_units' => [ 'px' ],
                                    'range' => [
                    ...
                    array(
                        'name' => 'extra',
                        'label' => esc_html__('Extra', 'seon'),
                        'tab' => \Elementor\Controls_Manager::TAB_STYLE,
                        'controls' => array(
                            array(
                                'name' => 'notification_color',
                                'label' => esc_html__('Notification Color', 'seon' ),
                                'type' => \Elementor\Controls_Manager::COLOR,
                                'selectors' => [
                            ...
                            array(
                                'name' => 'label_color',
                                'label' => esc_html__('Label Color', 'seon' ),
                                'type' => \Elementor\Controls_Manager::COLOR,
                                'selectors' => [
                            ...
                            array(
                                ...
                                'label' => esc_html__('Label Typography', 'seon' ),
                                'type' => \Elementor\Group_Control_Typography::get_type(),
                                'control_type' => 'group',
                            ...
                            array(
                                ...
                                'label' => esc_html__('Label Spacer Bottom', 'seon' ),
                                'type' => \Elementor\Controls_Manager::SLIDER,
                                'control_type' => 'responsive',
                                'size_units' => [ 'px' ],
                                'range' => [
                            ...
                            array(
                                'name' => 'icon_color',
                                'label' => esc_html__('Icon Color', 'seon' ),
                                'type' => \Elementor\Controls_Manager::COLOR,
                                'selectors' => [
                            ...
                            array(
                                ...
                                'label' => esc_html__( 'Radio Box Shadow', 'seon' ),
                                'type'         => \Elementor\Group_Control_Box_Shadow::get_type(),
                                'control_type' => 'group',
