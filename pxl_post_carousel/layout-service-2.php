...
<?php if (is_array($posts)): ?>
    <div class="pxl-swiper-slider pxl-service-grid pxl-service-carousel pxl-service-carousel2 pxl-service-style2 <?php echo esc_attr($settings['service_style_l1']); ?> <?php echo esc_attr($pxl_animate); ?>" <?php if($drap !== false): ?>data-cursor-drap="<?php echo esc_html('DRAG', 'seon'); ?>"<?php endif; ?>>
