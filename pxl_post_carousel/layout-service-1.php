...
<?php if (is_array($posts)): ?>
    <div class="pxl-swiper-slider pxl-service-carousel pxl-service-carousel1 pxl-service-style1 <?php echo esc_attr($settings['service_style_l1']); ?>" <?php if($drap !== false): ?>data-cursor-drap="<?php echo esc_html('DRAG', 'seon'); ?>"<?php endif; ?>>
                ...
                <div class="pxl-swiper-wrapper">
                    <?php
                        ...
                        <div class="pxl-swiper-slide">
                            <div class="pxl-item--inner pxl-not-active <?php echo esc_attr($pxl_animate); ?>">
                                ...
                                <?php if($show_button == 'true'): ?>
                                    <a class="pxl-btn-service" href="<?php if(!empty($service_external_link)) { echo esc_url($service_external_link); } else { echo esc_url(get_permalink( $post->ID )); } ?>">
