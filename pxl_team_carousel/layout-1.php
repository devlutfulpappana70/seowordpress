...
<?php if(isset($settings['team']) && !empty($settings['team']) && count($settings['team'])): 
    ...
    <div class="pxl-swiper-slider pxl-team pxl-team-carousel1 pxl-team-layout1 <?php echo esc_attr($settings['pxl_animate']); ?>" <?php if($drap !== false) : ?>data-cursor-drap="<?php echo esc_html('DRAG', 'seon'); ?>"<?php endif; ?>>
                                                ...
                                                <div class="pxl-social--icon">
                                                    <div class="row">
                                                        <?php foreach ($team_social as $value): ?>
                                                            <a class="col-3" href="<?php echo esc_url($value['url']); ?>" target="_blank"><i class="<?php echo esc_attr($value['icon']); ?>"></i></a>
                                                        <?php endforeach; ?>
                                                    </div>
                                                </div>
                                            </div>
