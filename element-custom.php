<?php 
/* Start Section */
add_action( 'elementor/element/section/section_structure/after_section_end', 'seon_add_custom_section_controls' ); 
add_action( 'elementor/element/section/section_structure/after_section_end', 'seon_add_custom_section_overlay_color' ); 
add_action( 'elementor/element/section/section_structure/after_section_end', 'seon_add_custom_section_overlay_img' ); 
add_action( 'elementor/element/section/section_structure/after_section_end', 'seon_add_custom_section_divider' ); 
add_action( 'elementor/element/section/section_structure/after_section_end', 'seon_add_custom_section_particles' );
add_action( 'elementor/element/section/section_structure/after_section_end', 'seon_add_custom_section_effect_image' );
function seon_add_custom_section_controls( \Elementor\Element_Base $element) {
     
    $element->start_controls_section(
        'section_pxl',
        [
            'label' => esc_html__( 'Seon General Settings', 'seon' ),
    ...
    if ( get_post_type( get_the_ID()) === 'pxl-template' && get_post_meta( get_the_ID(), 'template_type', true ) === 'header-mobile') {
        ...
        $element->add_control(
            'pxl_header_type',
            [
                'label' => esc_html__( 'Header Type', 'seon' ),
                'type'  => \Elementor\Controls_Manager::SELECT,
                'hide_in_inner' => true,
                'options'      => array(
                    ''          => esc_html__( 'Select Type', 'seon' ),
                    'sticky'      => esc_html__( 'Header Sticky', 'seon' ),
                ),
                'default'      => '',
            ]
        );
    ...
    $element->add_control(
        'row_scroll_fixed',
        [
            'label'   => esc_html__( 'Column Fixed', 'seon' ),
            'type'    => \Elementor\Controls_Manager::SELECT,
            'options' => array(
                'none'        => esc_html__( 'No', 'seon' ),
                'fixed'   => esc_html__( 'Yes', 'seon' ),
            ),
    ...
    $element->add_control(
        'row_zoom_point',
        [
            'label'   => esc_html__( 'Zoom Point', 'seon' ),
            'type'    => \Elementor\Controls_Manager::SELECT,
            'description' => 'Background color displayed on scroll.',
            'options' => array(
                'false'        => esc_html__( 'No', 'seon' ),
                'true'   => esc_html__( 'Yes', 'seon' ),
            ),
            'default'      => 'false',
    ...
    $element->add_control(
        ...
        [
            'label'   => esc_html__( 'Overflow', 'seon' ),
            'type'    => \Elementor\Controls_Manager::SELECT,
            'options' => array(
                'visible'        => esc_html__( 'Visible', 'seon' ),
                'hidden'   => esc_html__( 'Hidden', 'seon' ),
            ),
            'default'      => 'visible', 
            'separator' => 'after',
    ...
    $element->add_control(
        ...
        [
            'label'   => esc_html__( 'Section Fixed Scroll', 'seon' ),
            'type'    => \Elementor\Controls_Manager::SELECT,
            'options' => array(
                'none'        => esc_html__( 'None', 'seon' ),
                'top'        => esc_html__( 'Top', 'seon' ),
                'bottom'   => esc_html__( 'Bottom', 'seon' ),
            ),
            'default'      => 'none', 
            'separator' => 'after',
    ...
    $element->add_control(
        'pxl_parallax_bg_img',
        [
            'label' => esc_html__( 'Parallax Background Image', 'seon' ),
    ...
    $element->add_responsive_control(
        ...
        [
            'label' => esc_html__( 'Background Position', 'seon' ),
            'type'         => \Elementor\Controls_Manager::SELECT,
            'hide_in_inner' => true,
            'options'      => array(
    ...
    $element->add_responsive_control(
        ...
        [
            'label' => esc_html__( 'X Position', 'seon' ),
    ...
    $element->add_responsive_control(
        ...
        [
            'label' => esc_html__( 'Y Position', 'seon' ),
            'type' => \Elementor\Controls_Manager::SLIDER,  
            'hide_in_inner' => true,
            'size_units' => [ 'px', 'em', '%', 'vw' ],
            'default' => [
    ...
    $element->add_responsive_control(
        ...
        [
            'label' => esc_html__( 'Background Size', 'seon' ),
            'type'         => \Elementor\Controls_Manager::SELECT,
            'hide_in_inner' => true,
            'options'      => array(
                ''              => esc_html__( 'Default', 'seon' ),
    ...
    $element->add_responsive_control(
        ...
        [
            'label' => esc_html__( 'Background Width', 'seon' ),
            'type' => \Elementor\Controls_Manager::SLIDER,  
            'hide_in_inner' => true,
            'size_units' => [ 'px', 'em', '%', 'vw' ],
            'range' => [
    ...
    $element->add_control(
        ...
        [
            'label' => esc_html__( 'Parallax Background Position', 'seon' ),
            'type' => \Elementor\Controls_Manager::POPOVER_TOGGLE,
            'label_off' => esc_html__( 'Default', 'seon' ),
            'label_on' => esc_html__( 'Custom', 'seon' ),
            'return_value' => 'yes',
            'condition'     => [
                'pxl_parallax_bg_img[url]!' => ''
            ] 
    ...
    $element->start_popover();
        $element->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Left', 'seon' ).' (50px) px,%,vw,auto',
                'type' => 'text',
                'default' => '',
                'selectors' => [
        ...
        $element->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Top', 'seon' ).' (50px) px,%,vw,auto',
                'type' => 'text',
                'default' => '',
                'selectors' => [
        ...
        $element->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Right', 'seon' ).' (50px) px,%,vw,auto',
                'type' => 'text',
                'default' => '',
                'selectors' => [
        ...
        $element->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Bottom', 'seon' ).' (50px) px,%,vw,auto',
                'type' => 'text',
                'default' => '',
                'selectors' => [
    ...
    $element->add_control(
        ...
        [
            'label' => esc_html__( 'Parallax Background Effect', 'seon' ),
            'type' => \Elementor\Controls_Manager::POPOVER_TOGGLE,
            'label_off' => esc_html__( 'Default', 'seon' ),
            'label_on' => esc_html__( 'Custom', 'seon' ),
            'return_value' => 'yes',
    ...
    $element->start_popover();
        $element->add_control(
            ...
            [
                'label' => esc_html__( 'TranslateX', 'seon' ).' (-80)',
                'type' => 'text',
                'default' => '',
                'condition'     => [
                    'pxl_parallax_bg_img[url]!' => ''
        ...
        $element->add_control(
            ...
            [
                'label' => esc_html__( 'TranslateY', 'seon' ).' (-80)',
                'type' => 'text',
                'default' => '',
                'condition'     => [
                    'pxl_parallax_bg_img[url]!' => ''
        ...
        $element->add_control(
            ...
            [
                'label' => esc_html__( 'TranslateZ', 'seon' ).' (-80)',
                'type' => 'text',
                'default' => '',
                'condition'     => [
                    'pxl_parallax_bg_img[url]!' => ''
        ...
        $element->add_control(
            ...
            [
                'label' => esc_html__( 'Rotate X', 'seon' ).' (30)',
                'type' => 'text',
                'default' => '',
                'condition'     => [
                    'pxl_parallax_bg_img[url]!' => ''
        ...
        $element->add_control(
            ...
            [
                'label' => esc_html__( 'Rotate Y', 'seon' ).' (30)',
                'type' => 'text',
                'default' => '',
                'condition'     => [
                    'pxl_parallax_bg_img[url]!' => ''
        ...
        $element->add_control(
            ...
            [
                'label' => esc_html__( 'Rotate Z', 'seon' ).' (30)',
                'type' => 'text',
                'default' => '',
                'condition'     => [
                    'pxl_parallax_bg_img[url]!' => ''
        ...
        $element->add_control(
            ...
            [
                'label' => esc_html__( 'Scale X', 'seon' ).' (1.2)',
                'type' => 'text',
                'default' => '',
                'condition'     => [
                    'pxl_parallax_bg_img[url]!' => ''
        ...
        $element->add_control(
            ...
            [
                'label' => esc_html__( 'Scale Y', 'seon' ).' (1.2)',
                'type' => 'text',
                'default' => '',
                'condition'     => [
                    'pxl_parallax_bg_img[url]!' => ''
        ...
        $element->add_control(
            ...
            [
                'label' => esc_html__( 'Scale Z', 'seon' ).' (1.2)',
                'type' => 'text',
                'default' => '',
                'condition'     => [
                    'pxl_parallax_bg_img[url]!' => ''
        ...
        $element->add_control(
            ...
            [
                'label' => esc_html__( 'Scale', 'seon' ).' (1.2)',
                'type' => 'text',
                'default' => '',
                'condition'     => [
                    'pxl_parallax_bg_img[url]!' => ''
        ...
        $element->add_control(
            ...
            [
                'label' => esc_html__( 'Scroll From (px)', 'seon' ).' (350) from offset top',
                'type' => 'text',
                'default' => '',
                'condition'     => [
                    'pxl_parallax_bg_img[url]!' => ''
    ...
    $element->add_responsive_control(
        ...
        [
            'label'      => esc_html__( 'Parallax Opacity (0 - 100)', 'seon' ),
            'type' => \Elementor\Controls_Manager::SLIDER,
            'size_units' => [ '%' ],
            'range' => [
                '%' => [
    ...
    $element->add_control(
        ...
        [
          'label' => esc_html__( 'Full Content with space from?', 'seon' ),
          'type'         => \Elementor\Controls_Manager::SELECT,
                'prefix_class' => 'pxl-full-content-with-space-',
                'options'      => array(
                    'none'    => esc_html__( 'None', 'seon' ),
                    'start'   => esc_html__( 'Start', 'seon' ),
                    'end'     => esc_html__( 'End', 'seon' ),
                ),
                'default'      => 'none',
                'condition' => [
                    'layout' => 'full_width'
    ...
    $element->add_control(
        'pxl_container_width',
        [
                'label' => esc_html__('Container Width', 'seon'),
...
function seon_add_custom_section_overlay_color( \Elementor\Element_Base $element) {
     
    $element->start_controls_section(
        'section_overlay_color',
        [
            'label' => esc_html__( 'Seon Overlay Color', 'seon' ),
            'tab' => \Elementor\Controls_Manager::TAB_LAYOUT,
        ]
    );
    ...
    $element->add_control(
        ...
        [
            ...
            'options' => array(
                'none'        => esc_html__( 'No', 'seon' ),
                'full'   => esc_html__( 'Full', 'seon' ),
                'skew'   => esc_html__( 'Skew', 'seon' ),
            ),
    ...
    $element->add_responsive_control(
        'overlay_left_space',
        [
            'label' => esc_html__('Overlay Left Space', 'seon' ),
            'type' => \Elementor\Controls_Manager::SLIDER,
    ...
    $element->add_responsive_control(
        'overlay_right_space',
        [
            'label' => esc_html__('Overlay Right Space', 'seon' ),
            'type' => \Elementor\Controls_Manager::SLIDER,
            'control_type' => 'responsive',
            'size_units' => [ 'px','%' ],
            'range' => [
    ...
    $element->add_control(
        ...
        [
            'label' => esc_html__('Overlay Border Radius', 'seon' ),
...
function seon_add_custom_section_overlay_img( \Elementor\Element_Base $element) {
     
    $element->start_controls_section(
        'section_overlay_img',
        [
            'label' => esc_html__( 'Seon Overlay Image', 'seon' ),
            'tab' => \Elementor\Controls_Manager::TAB_LAYOUT,
        ]
    );
    ...
    $element->add_control(
        'pxl_overlay_display',
        [
            'label'   => esc_html__( 'Overlay Image', 'seon' ),
            'type'    => \Elementor\Controls_Manager::SELECT,
            'options' => array(
                'none'        => esc_html__( 'No', 'seon' ),
                'image'   => esc_html__( 'Yes', 'seon' ),
            ),
    ...
    $element->add_control(
        'pxl_overlay_img',
        [
            'label'   => esc_html__( 'Select Image 1', 'seon' ),
            'type'    => \Elementor\Controls_Manager::MEDIA,
            'condition' => [
    ...
    $element->add_responsive_control(
        ...
        [
            'label' => esc_html__( 'Background Position - Image 1', 'seon' ),
            'type'         => \Elementor\Controls_Manager::SELECT,
            'hide_in_inner' => true,
            'options'      => array(
                ''              => esc_html__( 'Default', 'seon' ),
    ...
    $element->add_responsive_control(
        ...
        [
            'label' => esc_html__('Border Radius - Image 1', 'seon' ),
            'type' => \Elementor\Controls_Manager::DIMENSIONS,
            'control_type' => 'responsive',
            'selectors' => [
    ...
    $element->add_responsive_control(
        ...
        [
            'label' => esc_html__('Margin - Image 1', 'seon' ),
            'type' => \Elementor\Controls_Manager::DIMENSIONS,
            'control_type' => 'responsive',
            'selectors' => [
    ...
    $element->add_responsive_control(
        ...
        [
            'label' => esc_html__('Width Image 1', 'seon' ),
            'type' => \Elementor\Controls_Manager::SLIDER,
            'control_type' => 'responsive',
            'size_units' => [ '%', 'px' ],
            'range' => [
    ...
    $element->add_control(
        'pxl_overlay_img2',
        [
            'label'   => esc_html__( 'Select Image 2', 'seon' ),
            'type'    => \Elementor\Controls_Manager::MEDIA,
            'condition' => [
                'pxl_overlay_display' => ['image'],
            ],
    ...
    $element->add_responsive_control(
        ...
        [
            'label' => esc_html__( 'Background Position - Image 2', 'seon' ),
            'type'         => \Elementor\Controls_Manager::SELECT,
            'hide_in_inner' => true,
            'options'      => array(
                ''              => esc_html__( 'Default', 'seon' ),
    ...
    $element->add_responsive_control(
        ...
        [
            'label' => esc_html__('Border Radius - Image 2', 'seon' ),
            'type' => \Elementor\Controls_Manager::DIMENSIONS,
            'control_type' => 'responsive',
            'selectors' => [
    ...
    $element->add_responsive_control(
        ...
        [
            'label' => esc_html__('Margin - Image 2', 'seon' ),
            'type' => \Elementor\Controls_Manager::DIMENSIONS,
            'control_type' => 'responsive',
            'selectors' => [
    ...
    $element->add_responsive_control(
        ...
        [
            'label' => esc_html__('Width Image 2', 'seon' ),
            'type' => \Elementor\Controls_Manager::SLIDER,
            'control_type' => 'responsive',
            'size_units' => [ '%', 'px' ],
            'range' => [
    ...
    $element->add_responsive_control(
        ...
        [
            'label' => esc_html__('Offset Left - Image 2', 'seon' ),
            'type' => \Elementor\Controls_Manager::SLIDER,
            'control_type' => 'responsive',
            'size_units' => [ 'px' ],
            'range' => [
...
function seon_add_custom_section_divider( \Elementor\Element_Base $element) {
     
    $element->start_controls_section(
        'section_divider',
        [
            'label' => esc_html__( 'Seon Divider', 'seon' ),
            'tab' => \Elementor\Controls_Manager::TAB_LAYOUT,
        ]
    );
    ...
    $element->add_control(
        'row_divider',
        [
            'label'   => esc_html__( 'Divider', 'seon' ),
            'type'    => \Elementor\Controls_Manager::SELECT,
            'options' => array(
                ''        => esc_html__( 'None', 'seon' ),
                'rounded-top'   => esc_html__( 'Rounded Top', 'seon' ),
                'angle-top'   => esc_html__( 'Angle Top Left', 'seon' ),
                'angle-top-right'   => esc_html__( 'Angle Top Right', 'seon' ),
                'angle-bottom-left'   => esc_html__( 'Angle Bottom Left', 'seon' ),
                'angle-bottom'   => esc_html__( 'Angle Bottom Right', 'seon' ),
                'angle-top-bottom'   => esc_html__( 'Angle Top & Bottom Right', 'seon' ),
                'angle-top-bottom-left'   => esc_html__( 'Angle Top & Bottom Left', 'seon' ),
                'wave-animation-top'   => esc_html__( 'Wave Animation Top', 'seon' ),
                'wave-animation-bottom'   => esc_html__( 'Wave Animation Bottom 1', 'seon' ),
                'wave-animation-bottom2'   => esc_html__( 'Wave Animation Bottom 2', 'seon' ),
                'curved-top'   => esc_html__( 'Curved Top', 'seon' ),
                'curved-bottom'   => esc_html__( 'Curved Bottom', 'seon' ),
                'vertical1'   => esc_html__( 'Divider Vertical', 'seon' ),
                'curved-arrow'   => esc_html__( 'Curved Arrow', 'seon' ),
                'curved-arrow-inner-top'   => esc_html__( 'Curved Arrow Inner Top', 'seon' ),
                'curved-arrow-inner-bottom'   => esc_html__( 'Curved Arrow Inner Bottom', 'seon' ),
                'divider-border'   => esc_html__( 'Divider Broder Top/Bottom', 'seon' ),
            ),
    ...
    $element->add_control(
        'divider_color',
        [
            'label' => esc_html__('Divider Color', 'seon' ),
            'type' => \Elementor\Controls_Manager::COLOR,
            'selectors' => [
    ...
    $element->add_responsive_control(
        'divider_height',
        [
            'label' => esc_html__('Divider Height', 'seon' ),
            'type' => \Elementor\Controls_Manager::SLIDER,
            'control_type' => 'responsive',
            'size_units' => [ 'px' ],
            'range' => [
...
function seon_add_custom_section_particles( \Elementor\Element_Base $element) {
     
    $element->start_controls_section(
        'section_particles',
        [
            'label' => esc_html__( 'Seon Particles', 'seon' ),
            'tab' => \Elementor\Controls_Manager::TAB_LAYOUT,
        ]
    );
    ...
    $element->add_control(
        ...
        [
            'label'   => esc_html__( 'Particles', 'seon' ),
    ...
    $element->add_control(
        'size_random',
        [
                'label' => esc_html__('Size Random', 'seon'),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'default' => 'false',
                'condition' => [
                    'row_particles_display' => ['yes'],
    ...
    $element->add_control(
        'move_direction',
        [
            'label'   => esc_html__( 'Move Direction', 'seon' ),
            'type'    => \Elementor\Controls_Manager::SELECT,
            'options' => array(
                'none'        => esc_html__( 'None', 'seon' ),
                'top'        => esc_html__( 'Top', 'seon' ),
...
function seon_add_custom_section_effect_image( \Elementor\Element_Base $element) {
     
    $element->start_controls_section(
        'section_effect_image',
        [
            'label' => esc_html__( 'Seon Effect Images', 'seon' ),
            'tab' => \Elementor\Controls_Manager::TAB_LAYOUT,
        ]
    );
    ...
    $repeater_img->add_control(
        'image_position', 
        [
            'label' => esc_html__('Image Position', 'seon' ),
            'type' => \Elementor\Controls_Manager::SELECT,
            'options' => [
                'p-top-left' => 'Top Left',
    ...
    $repeater_img->add_control(
        'image_position_top', 
        [
            'label' => esc_html__('Top Position', 'seon' ),
            'type' => \Elementor\Controls_Manager::SLIDER,
            'size_units' => [ 'px', '%' ],
            'control_type' => 'responsive',
            'default' => [
    ...
    $repeater_img->add_control(
        'image_position_left', 
        [
            'label' => esc_html__('Left Position', 'seon' ),
            'type' => \Elementor\Controls_Manager::SLIDER,
            'size_units' => [ 'px', '%' ],
            'control_type' => 'responsive',
            'default' => [
    ...
    $repeater_img->add_control(
        ...
        [
            'label' => esc_html__('Bottom Position', 'seon' ),
            'type' => \Elementor\Controls_Manager::SLIDER,
            'size_units' => [ 'px', '%' ],
            'control_type' => 'responsive',
            'default' => [
    ...
    $repeater_img->add_control(
        ...
        [
            'label' => esc_html__('Right Position', 'seon' ),
            'type' => \Elementor\Controls_Manager::SLIDER,
            'size_units' => [ 'px', '%' ],
            'control_type' => 'responsive',
            'default' => [
    ...
    $repeater_img->add_control(
        ...
        [
            'label' => esc_html__('Parallax Scroll Value', 'seon' ),
    ...
    $repeater_img->add_control(
        ...
        [
            'label' => esc_html__('Parallax Hover Value', 'seon' ),
            'type' => \Elementor\Controls_Manager::TEXT,
            'default' => '40',
            'description' => esc_html__('Enter number.', 'seon' ),
            'condition' => [
    ...
    $repeater_img->add_control(
        'image_display_md', 
        [
            'label' => esc_html__('Hide on Screen <= 1200px', 'seon'),
            'type' => \Elementor\Controls_Manager::SWITCHER,
            'default' => 'false',
        ]
    );
    ...
    $repeater_img->add_control(
        'image_display_sm', 
        [
            'label' => esc_html__('Hide on Screen <= 767px', 'seon'),
            'type' => \Elementor\Controls_Manager::SWITCHER,
            'default' => 'false',
        ]
    );
...
/* Start Column */
add_action( 'elementor/element/column/layout/after_section_end', 'seon_add_custom_columns_controls' ); 
function seon_add_custom_columns_controls( \Elementor\Element_Base $element) {
    $element->start_controls_section(
        'columns_pxl',
        [
            'label' => esc_html__( 'Seon General Settings', 'seon' ),
    ...
    $element->add_control(
        'col_content_align',
        [
            'label'   => esc_html__( 'Column Content Align', 'seon' ),
            'type'    => \Elementor\Controls_Manager::SELECT,
            'options' => array(
                ''           => esc_html__( 'Default', 'seon' ),
                'start'           => esc_html__( 'Start', 'seon' ),
                'center'           => esc_html__( 'Center', 'seon' ),
                'end'           => esc_html__( 'End', 'seon' ),
            ),
            'default' => '',
    ...
    $element->add_control(
        'col_sticky',
        [
            'label'   => esc_html__( 'Column Sticky', 'seon' ),
            'type'    => \Elementor\Controls_Manager::SELECT,
            'options' => array(
                'none'           => esc_html__( 'No', 'seon' ),
                'sticky' => esc_html__( 'Yes', 'seon' ),
            ),
            'default' => 'none',
    ...
    $element->add_control(
        ...
        [
            'label' => esc_html__( 'Sticky Offset Top', 'seon' ),
            'type' => 'text',
            'description' => esc_html__('Enter number.', 'seon' ),
            'default'  => '30',
            'selectors' => [
    ...
    $element->add_control(
        ...
        [
            'label' => esc_html__('Overflow Hidden', 'seon'),
            'type' => \Elementor\Controls_Manager::SWITCHER,
            'label_on' => esc_html__( 'Yes', 'seon' ),
            'label_off' => esc_html__( 'No', 'seon' ),
            'return_value' => 'yes',
            'default' => 'no',
            'separator' => 'after',
...
add_action( 'elementor/element/after_add_attributes', 'seon_custom_el_attributes', 10, 1 );
function seon_custom_el_attributes($el){
...
add_filter( 'pxl-custom-section/before-render', 'seon_custom_section_before_render', 10, 3 );
function seon_custom_section_before_render($html ,$settings, $el) {
...
add_filter( 'pxl-custom-column/before-render', 'seon_custom_column_before_render', 10, 3 );
function seon_custom_column_before_render($html, $settings, $el){
